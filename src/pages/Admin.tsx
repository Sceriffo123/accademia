                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center space-x-4 text-sm text-gray-600">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                            ...
                            {document.status === 'PUBLISHED' ? 'Pubblicato' :
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setDocumentForm({...documentForm, status: e.target.value as 'PUBLISHED' | 'DRAFT' | 'ARCHIVED'})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <div className="px-3 py-2 bg-gray-50 border border-gray-200 rounded-lg text-gray-900">
                      <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                        viewingDocument.status === 'PUBLISHED' ? 'bg-green-100 text-green-800' :
                        viewingDocument.status === 'DRAFT' ? 'bg-yellow-100 text-yellow-800' :
                        'bg-red-100 text-red-800'
                      }`}>
                        {viewingDocument.status === 'PUBLISHED' ? 'Pubblicato' :
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div>
                    ...
                    <select
                      ...
                      onChange={(e) => setEditingDocument({...editingDocument, status: e.target.value as 'PUBLISHED' | 'DRAFT' | 'ARCHIVED'})}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                    >
                      <option value="PUBLISHED">Pubblicato</option>
                      <option value="DRAFT">Bozza</option>
